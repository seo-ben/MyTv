...
const String isEmailVerified = "isEmailVerified";
...
class LocalStorage {
  ...
  static String? getUserToken() {
    var rtrn = GetStorage().read(userTokenKey);
  ...
  static Future<void> signOut() async {
    ...
    // ✅ NE PAS supprimer isOnBoardDoneKey pour garder l'historique de l'appareil
    // Comportement comme YouTube : le splash ne s'affiche qu'une seule fois par installation
