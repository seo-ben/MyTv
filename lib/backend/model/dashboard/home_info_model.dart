...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        footballSectionData: List<FootballSectionDatum>.from(
            json["footballSectionData"]
                .map((x) => FootballSectionDatum.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "footballSectionData":
            List<dynamic>.from(footballSectionData.map((x) => x.toJson())),
        "sportsCategory":
            List<dynamic>.from(sportsCategory.map((x) => x.toJson())),
      };
}
