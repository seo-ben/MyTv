  ...
  void saveInfo() {
    ...
    if (basicSettings.siteLogo == '') {
      appBasicLogoWhite.value =
          "${ApiEndpoint.mainDomain}/${_appSettingsModel!.data.appImagePaths.pathLocation}/${basicSettings.siteLogo}";
      ...
      appBasicLogoDark.value =
          "${ApiEndpoint.mainDomain}/${_appSettingsModel!.data.appImagePaths.pathLocation}/${basicSettings.siteLogoDark}";
    }
