...
class Themes {
  ...
  static ThemeData light = ThemeData.light().copyWith(
      ...
      colorScheme:
          const ColorScheme.light(surface: CustomColor.primaryLightTextColor),
  ...
  static ThemeData dark = ThemeData.dark().copyWith(
    ...
    colorScheme:
        const ColorScheme.light(surface: CustomColor.primaryDarkTextColor),
    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: CustomColor.primaryDarkColor,
    ),
    appBarTheme: const AppBarTheme(
      scrolledUnderElevation: 0,
      backgroundColor: CustomColor.primaryLightScaffoldBackgroundColor,
      actionsIconTheme: IconThemeData(color: CustomColor.whiteColor),
      iconTheme: IconThemeData(
        color:
            CustomColor.whiteColor, // Change the color of the back button icon
      ),
    ),
  );
