...
import '/controller/drawer/highlight/highlight_screen_controller.dart';
...
class HighlightsScreen extends StatelessWidget {
  ...
  final controller = Get.put(HighlightScreenController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TitleHeading2Widget(text: Strings.highlights),
  ...
  _bodyWidget(BuildContext context) {
    var data = controller.highlightModel.data.highlight;
    var imagePath = controller.highlightModel.data.liveImagePath;
